...
CUDA_VISIBLE_DEVICES=0 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.00005 --pretrain_batch_size=32 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-32 lr-0.00005" &
CUDA_VISIBLE_DEVICES=1 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0001 --pretrain_batch_size=32 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-32 lr-0.0001" &
wait
CUDA_VISIBLE_DEVICES=0 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0002 --pretrain_batch_size=32 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-32 lr-0.0002" &
CUDA_VISIBLE_DEVICES=1 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0003 --pretrain_batch_size=32 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-32 lr-0.0003" &
wait

CUDA_VISIBLE_DEVICES=0 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.00005 --pretrain_batch_size=16 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-16 lr-0.00005" &
CUDA_VISIBLE_DEVICES=1 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0001 --pretrain_batch_size=16 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-16 lr-0.0001" &
wait
CUDA_VISIBLE_DEVICES=0 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0002 --pretrain_batch_size=16 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-16 lr-0.0002" &
CUDA_VISIBLE_DEVICES=1 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0003 --pretrain_batch_size=16 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-16 lr-0.0003" &
wait

CUDA_VISIBLE_DEVICES=0 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.00005 --pretrain_batch_size=8 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-8 lr-0.00005" &
CUDA_VISIBLE_DEVICES=1 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0001 --pretrain_batch_size=8 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-8 lr-0.0001" &
wait
CUDA_VISIBLE_DEVICES=0 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0002 --pretrain_batch_size=8 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-8 lr-0.0002" &
CUDA_VISIBLE_DEVICES=1 python src/main.py --transfer --config=tr_sf_mto --env-config=sc2_v2_protoss --task-config=sc2_v2_test --lr=0.0003 --pretrain_batch_size=8 --seed=1234 --use_wandb=True --wandb_note="sc2_v2 bs-8 lr-0.0003" &
wait